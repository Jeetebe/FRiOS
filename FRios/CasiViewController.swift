...
class CasiViewController: UIViewController ,UICollectionViewDelegate, UICollectionViewDataSource{

    
    @IBOutlet weak var collCasi: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        self.collCasi?.collectionViewLayout = columnLayout
        alamofireGetCasi()
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell:CellCasi = collectionView.dequeueReusableCell(withReuseIdentifier: "cellsinger", for: indexPath) as! CellCasi
    ...
    func alamofireGetCasi() {
        let todoEndpoint: String = "http://123.30.100.126:8081/Restapi/rest/Appservice/listsinger/noibat"
        Alamofire.request(todoEndpoint)
            ...
            .responseJSON { response in
                ...
                for element in json {
                    if let todoResult = Singer(json: element) {
